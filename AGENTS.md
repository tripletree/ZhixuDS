...
4. React mirror (for HTML prototypes/mocks): `components/core/*.jsx` + `components/ui/*.jsx` (app-level: Panel, Tag/StatusDot, Stat, Progress, Sparkline/SparkBars, Tabs, Field/Input/TextArea/Select/Listbox, DataTable, Dialog) + `ui_kits/landing/`.
